...
class AdminFrame(tk.Frame):
    ...
    def _frame_create(self):
        self.division_dir_label = tk.Label(self, text='No directory')
        self.division_dir_label.pack()
        ...
        self.id_label = tk.Label(self, text='No division ID')
        self.id_label.pack(side=tk.BOTTOM)

        self.account_button = tk.Button(self, text='Account')
